...
Создание объекта DisjointSetUnion с массивами parent и rank.
Каждый сайт - отдельная компонента.
Обработка ввода:

Добавление пар сайтов в DSU, объединяя компоненты связности.
Объединение компонент:

Нахождение корней компонент и объединение с учетом ранга (высоты).
Вычисление размеров кластеров:

Создание массива dsuSizeArray.
Подсчет размеров компонент.
         */
